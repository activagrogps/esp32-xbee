...
// S3: high speed mode removed from LEDC hardware
#define LEDC_SPEED_MODE LEDC_LOW_SPEED_MODE
// S3: GPIO 22/23/25/27 do not exist (valid: 0-21, 26-48).
// GPIO 17/18 reserved for UM980 UART TX/RX - do not use here.
// Placeholders - adjust to actual board wiring.
...
#define STATUS_LED_SLEEP_GPIO GPIO_NUM_15
#define STATUS_LED_ASSOC_GPIO GPIO_NUM_16
#else
